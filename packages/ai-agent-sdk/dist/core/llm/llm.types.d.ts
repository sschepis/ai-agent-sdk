...
export type AnthropicModelId = "claude-4-sonnet-20250514:thinking" | "claude-4-sonnet-20250514" | "claude-4-opus-20250514:thinking" | "claude-4-opus-20250514" | "claude-3-7-sonnet-20250219:thinking" | "claude-3-7-sonnet-20250219";
export interface AnthropicModelProvider {
    provider: "anthropic";
    id: AnthropicModelId;
}
export type GoogleModelId = "gemini-2.5-flash-preview-05-20" | "gemini-2.5-flash-preview-05-20:thinking" | "gemini-2.5-pro-preview-05-06";
export interface GoogleModelProvider {
    provider: "google";
    id: GoogleModelId;
}
export type ModelProvider = OpenAIModelProvider | DeepSeekModelProvider | AnthropicModelProvider | GoogleModelProvider;
export type GenerateTextParams = Omit<Parameters<typeof generateText>[0], "model" | "tools"> & {
    tools?: ToolSet;
};
export type GenerateObjectParams = Omit<Parameters<typeof generateObject>[0], "model" | "schema" | "tools" | "toolChoice" | "output" | "mode"> & {
    schema: AnyZodObject;
};
